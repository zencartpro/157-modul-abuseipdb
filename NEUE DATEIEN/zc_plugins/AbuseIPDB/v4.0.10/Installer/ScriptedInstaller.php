 ...
 * @requires    Zen Cart 1.5.7k German and PHP 8.4.x
 * @author      Marcopolo
 * see https://github.com/CcMarc/AbuseIPDB
 * @copyright   2023-2026
 * @license     GNU General Public License (GPL) - https://www.gnu.org/licenses/gpl-3.0.html
 * @version     4.0.10
 * @updated     2026-06-19 - webchills for Zen Cart German 
 */
...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    public const ABUSEIPDB_CURRENT_VERSION = '4.0.10';
    ...
    protected function executeInstall(): bool
    {
        ...
        ('AbuseIPDB - Pfad zur Blacklist Textdatei', 'ABUSEIPDB_BLACKLIST_FILE_PATH', 'Der Pfad relativ zum Shopverzeichnis einschließlich des Dateinamens der Datei, die die IP-Adressen auf der Blacklist enthält. Jede IP-Adresse sollte in einer neuen Zeile stehen. Diese Datei wird nur verwendet, wenn die Einstellung Textdatei für IP Blacklist aktivieren aktiviert ist.<br>Lassen Sie diese Einstellung am besten auf includes/blacklist.txt und laden Sie Ihre blacklist.txt ins includes Verzeichnis.<br>', 43),
