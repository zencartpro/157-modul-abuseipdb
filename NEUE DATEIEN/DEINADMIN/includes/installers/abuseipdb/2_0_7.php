...
('Log File Path', 'ABUSEIPDB_LOG_FILE_PATH', 'logs/', 'The path to the directory where log files are stored.', @gid, now(), 9, NULL, NULL),
...
('AbuseIPDB - Logfile Pfad', 'ABUSEIPDB_LOG_FILE_PATH', 'Pfad zum Ordner, in dem die AbuseIPDB Logfiles gespeichert werden sollen:<br>', 43),
